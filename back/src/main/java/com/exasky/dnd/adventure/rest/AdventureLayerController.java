...
public class AdventureLayerController {
    ...
    public <DTO extends LayerItemDto<DTO, BO>, BO extends LayerItem> void addLayerItem(@PathVariable Long adventureId,
            @RequestBody DTO dto) {
    ...
    public <DTO extends LayerItemDto<DTO, BO>, BO extends LayerItem> void updateLayerItem(
            @PathVariable Long adventureId, @RequestBody DTO dto) {
    ...
    public <DTO extends LayerItemDto<DTO, BO>, BO extends LayerItem> void deleteLayerItem(
            @PathVariable Long adventureId, @RequestBody DTO dto) {
